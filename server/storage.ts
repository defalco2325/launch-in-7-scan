...
export class MemStorage implements IStorage {
  ...
  async updateScan(id: string, updates: Partial<Omit<Scan, 'id' | 'createdAt'>>): Promise<Scan | undefined> {
    ...
    const updated: Scan = {
      ...
      mobilePerformanceScore: updates.mobilePerformanceScore ?? scan.mobilePerformanceScore ?? null,
      mobileAccessibilityScore: updates.mobileAccessibilityScore ?? scan.mobileAccessibilityScore ?? null,
      mobileBestPracticesScore: updates.mobileBestPracticesScore ?? scan.mobileBestPracticesScore ?? null,
      mobileSeoScore: updates.mobileSeoScore ?? scan.mobileSeoScore ?? null,
      mobileCoreWebVitals: updates.mobileCoreWebVitals ?? scan.mobileCoreWebVitals ?? null,
      mobileTopIssues: updates.mobileTopIssues ?? scan.mobileTopIssues ?? null,
